<template>
	<view>
		...
		<tabList :tabs="tabList"  color="#1492FF" hei="64"  :fontSize="26" :tabLineHei="6" :fiexd="true" :top="150"  nextColor="#666666"></tabList>
	...
	export default {
		...
		data() {
			return {
				...
				//侧滑数据
				sexList    : ["全部","带训教练","助理教练",],
				sexListCin : 0,
				sexName    : "带训教练",
				

				otherList  : [{name:'全部', itemId :287},{name:'帆船', itemId:288},{name:'攀岩', itemId:288},{name:'击剑', itemId:288},{name:'马数',itemId:288},{name:'赛艇', itemId:288},{name:'自行车', itemId:288},{name:'设计', itemId:288},{name:'空手道', itemId:288},{name:'跳水', itemId:288}],
				baItemID   : 287,
